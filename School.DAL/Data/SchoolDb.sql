USE [School]
GO
/****** Object:  Table [dbo].[Person]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CourseInstructor]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Course]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ViewInstructors]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE VIEW [dbo].[ViewInstructors]
AS
SELECT pe.PersonID as InstructorId, pe.FirstName, pe.LastName, 
 CONVERT(DATE,pe.HireDate) AS HireDate, 
 co.CourseID as CourseId, 
 co.Title as Course FROM dbo.Person pe
 JOIN dbo.CourseInstructor ci on ci.PersonID = pe.PersonID
 JOIN dbo.Course co on co.CourseID= ci.CourseID
GO
/****** Object:  Table [dbo].[StudentGrade]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[ViewStudents]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT pe.PersonID as StudentId,  pe.FirstName, pe.LastName, pe.HireDate, sg.Grade FROM Person pe
JOIN StudentGrade sg on pe.PersonID = sg.StudentID
GO
/****** Object:  Table [dbo].[Department]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Instructors]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OfficeAssignment]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OnlineCourse]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OnsiteCourse]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Students]    Script Date: 10/19/2022 8:09:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[CourseInstructor] ([CourseID], [PersonID]) VALUES (1045, 35)
GO
INSERT [dbo].[CourseInstructor] ([CourseID], [PersonID]) VALUES (1045, 36)
GO
...
GO
INSERT [dbo].[Department] ([DepartmentID], [Name], [Budget], [StartDate], [Administrator], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (4, N'Economics', 200000.0000, CAST(N'2007-09-01T00:00:00.000' AS DateTime), 4, CAST(N'2021-02-22T16:41:20.160' AS DateTime), NULL, 1, NULL, 1, CAST(N'2022-09-02T19:56:33.230' AS DateTime), 1)
GO
...
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (1, N'Abercrombie', N'Kim', CAST(N'1995-03-11T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (4, N'Fakhouri', N'Fadi', CAST(N'2002-08-06T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (5, N'Harui', N'Roger', CAST(N'1998-07-01T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (18, N'Zheng', N'Roger', CAST(N'2004-02-12T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (25, N'Kapoor', N'Candace', CAST(N'2001-01-15T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (27, N'Serrano', N'Stacy', CAST(N'1999-06-01T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (31, N'Stewart', N'Jasmine', CAST(N'1997-10-12T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (32, N'Xu', N'Kristen', CAST(N'2001-07-23T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (34, N'Van Houten', N'Roger', CAST(N'2000-12-07T00:00:00.000' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (35, N'Perez', N'Jose', CAST(N'2021-03-22T20:01:19.813' AS DateTime))
GO
INSERT [dbo].[Instructors] ([Id], [LastName], [FirstName], [HireDate]) VALUES (36, N'De Leon', N'Jose', CAST(N'2021-03-29T19:41:09.437' AS DateTime))
GO
...
GO
INSERT [dbo].[Person] ([PersonID], [LastName], [FirstName], [HireDate], [EnrollmentDate], [Discriminator]) VALUES (35, N'Perez', N'Jose', CAST(N'2021-03-22T20:01:19.813' AS DateTime), NULL, N'Instructor')
GO
INSERT [dbo].[Person] ([PersonID], [LastName], [FirstName], [HireDate], [EnrollmentDate], [Discriminator]) VALUES (36, N'De Leon', N'Jose', CAST(N'2021-03-29T19:41:09.437' AS DateTime), CAST(N'2021-03-29T19:41:09.113' AS DateTime), N'Instructor')
GO
...
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (2, N'Barzdukas Prueba', N'Gytis Hola', CAST(N'2005-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), CAST(N'2022-10-18T20:43:41.377' AS DateTime), 1, 1, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (3, N'Justice', N'Peggy', CAST(N'2001-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (6, N'Li', N'Yan', CAST(N'2002-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (7, N'Norman', N'Laura', CAST(N'2003-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (8, N'Olivotto', N'Nino', CAST(N'2005-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (9, N'Tang', N'Wayne', CAST(N'2005-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (10, N'Alonso', N'Meredith', CAST(N'2002-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (11, N'Lopez', N'Sophia', CAST(N'2004-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (12, N'Browning', N'Meredith', CAST(N'2000-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (13, N'Anand', N'Arturo', CAST(N'2003-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (14, N'Walker', N'Alexandra', CAST(N'2000-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (15, N'Powell', N'Carson', CAST(N'2004-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (16, N'Jai', N'Damien', CAST(N'2001-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (17, N'Carlson', N'Robyn', CAST(N'2005-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (19, N'Bryant', N'Carson', CAST(N'2001-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (20, N'Suarez', N'Robyn', CAST(N'2004-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (21, N'Holt', N'Roger', CAST(N'2004-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (22, N'Alexander', N'Carson', CAST(N'2005-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (23, N'Morgan', N'Isaiah', CAST(N'2001-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (24, N'Martin', N'Randall', CAST(N'2005-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (26, N'Rogers', N'Cody', CAST(N'2002-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (28, N'White', N'Anthony', CAST(N'2001-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (29, N'Griffin', N'Rachel', CAST(N'2004-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (30, N'Shan', N'Alicia', CAST(N'2003-09-01T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (33, N'Gao', N'Erica', CAST(N'2003-01-30T00:00:00.000' AS DateTime), CAST(N'2022-10-18T19:22:39.717' AS DateTime), NULL, 1, NULL, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (34, N'Perez', N'Jose', CAST(N'2022-10-18T20:52:00.000' AS DateTime), CAST(N'2022-10-18T20:53:00.307' AS DateTime), CAST(N'2022-10-18T20:53:00.307' AS DateTime), 0, 1, NULL, NULL, 0)
GO
INSERT [dbo].[Students] ([Id], [LastName], [FirstName], [EnrollmentDate], [CreationDate], [ModifyDate], [CreationUser], [UserMod], [UserDeleted], [DeletedDate], [Deleted]) VALUES (35, N'GONZALES', N'JUAN', CAST(N'2022-10-18T20:55:00.000' AS DateTime), CAST(N'2022-10-18T20:55:27.257' AS DateTime), CAST(N'2022-10-18T20:57:12.370' AS DateTime), 1, 1, NULL, NULL, 0)
GO
...
GO
ALTER TABLE [dbo].[Students] ADD  CONSTRAINT [DF_Students_CreationDate]  DEFAULT (getdate()) FOR [CreationDate]
GO
ALTER TABLE [dbo].[Students] ADD  CONSTRAINT [DF_Students_CreationUser]  DEFAULT ((1)) FOR [CreationUser]
GO
...
GO
/****** Object:  StoredProcedure [dbo].[AddInstructor]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[DeleteOfficeAssignment]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[DeletePerson]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetDepartmentName]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetInstructors]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[GetStudentGrades]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[InsertOfficeAssignment]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[InsertPerson]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[UpdateOfficeAssignment]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdatePerson]    Script Date: 10/19/2022 8:09:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
